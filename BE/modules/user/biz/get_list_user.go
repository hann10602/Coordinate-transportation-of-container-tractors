...
type GetListUserStorage interface {
	GetListUser(ctx context.Context, paging common.Paging) ([]modeluser.User, common.Paging, error)
}
...
func (biz *getListUserBiz) FindListUser(ctx context.Context, paging common.Paging) ([]modeluser.User, common.Paging, error) {
