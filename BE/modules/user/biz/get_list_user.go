...
type GetListUserStorage interface {
	GetListUser(ctx context.Context, paging common.Paging) ([]model.TUser, common.Paging, error)
}
...
func (biz *getListUserBiz) FindListUser(ctx context.Context, paging common.Paging) ([]model.TUser, common.Paging, error) {
