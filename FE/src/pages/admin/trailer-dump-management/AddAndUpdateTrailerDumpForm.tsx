...
import { TAddAndUpdateTrailerDump } from './types';
...
export const AddAndUpdateTrailerDumpForm = ({
  handleCloseModal,
  currentInstance,
  setCurrentInstance,
  ...
  const {
    ...
    watch,
    formState: { errors }
  } = useForm<TAddAndUpdateTrailerDump>();
  ...
  const handleSubmitAddForm = (e: TAddAndUpdateTrailerDump) => {
