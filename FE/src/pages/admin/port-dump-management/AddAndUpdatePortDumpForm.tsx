...
import { TAddAndUpdatePortDump } from './types';
...
export const AddAndUpdatePortDumpForm = ({
  handleCloseModal,
  currentInstance,
  setCurrentInstance,
  ...
  const handleSubmitAddForm = (e: TAddAndUpdatePortDump) => {
