...
import { AddAndUpdateContainerDumpForm } from './AddAndUpdateContainerDumpForm';
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex items-center gap-x-2">
          <Tooltip placement="top" title="Edit dump">
            <div
          ...
          <Tooltip placement="top" title="Delete dump">
            <div
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-between items-center mb-10">
        <p className="text-2xl font-semibold">Container dump</p>
        <Button className="px-10 py-5" onClick={() => setIsOpenAddAndUpdateForm(true)}>
          Add
        </Button>
        <AddAndUpdateContainerDumpForm
