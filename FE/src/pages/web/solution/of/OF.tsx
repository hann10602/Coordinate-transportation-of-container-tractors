    ...
    <div className="text-white">
      ...
      <div className="relative flex justify-center items-center h-[680px]">
        ...
        <div className="text-center px-4">
          <p className="text-4xl md:text-6xl font-bold">Giải pháp vận chuyển Outbound Freight</p>
          <p className="text-base md:text-xl mt-3">Vận chuyển container đầy từ kho khách hàng ra cảng </p>
