    ...
    <div className="text-white">
      ...
      <div className="relative flex justify-center items-center h-[680px]">
        ...
        <div className="text-center px-4">
          <p className="text-4xl md:text-6xl font-bold">Giải pháp vận chuyển Import Freight</p>
          <p className="text-base md:text-xl mt-3">Vận chuyển container đầy từ cảng về kho của khách hàng</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-16">
          <div className="bg-teal-400 space-y-2 rounded-md p-4">
            ...
            <p className="text-sm sm:text-base">
              Điều phối viên cập nhật kế hoạch điều phối vận tải lên hệ thống IF, thuật toán tự động đề xuất kế hoạch
